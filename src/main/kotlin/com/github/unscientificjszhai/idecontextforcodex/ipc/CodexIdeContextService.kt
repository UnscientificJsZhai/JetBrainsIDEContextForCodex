...
import com.github.unscientificjszhai.idecontextforcodex.ipc.router.IpcRouterPlatform
import com.github.unscientificjszhai.idecontextforcodex.ipc.router.UnixIpcRouterPlatform
import com.github.unscientificjszhai.idecontextforcodex.ipc.router.WindowsIpcRouterPlatform
import com.github.unscientificjszhai.idecontextforcodex.settings.CodexSettingsState
    ...
    fun start() {
        ...
        synchronized(lifecycleLock) {
            ...
            val platform = try {
                ...
                LOG.warn(
                    "IDEContextForCodex IPC 平台初始化失败：${exception.javaClass.simpleName}",
                )
                return
            }
            ...
            val job = coroutineScope.launch(start = CoroutineStart.LAZY) {
                try {
                    ...
                    LOG.warn("IDEContextForCodex IPC 已停止：${exception.javaClass.simpleName}")
                } finally {
